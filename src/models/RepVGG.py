...
class RepVGG(nn.Module):
    ...
    def __init__(self, num_blocks, nOut=1000, width_multiplier=None, override_groups_map=None, deploy=False, use_se=False, **kwargs):
...
def MainModel(nOut=256, **kwargs):
    model = 'RepVGG-D2se'
    return get_RepVGG_func_by_name(model)(nOut=nOut, deploy=False, **kwargs)
